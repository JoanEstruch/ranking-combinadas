...
# CONFIG
# ============================
input_file = "/home/truji/Desktop/streamlit_app/limpio/U16M/U16M.xlsx"
output_file = "/home/truji/Desktop/streamlit_app/limpio/U16M_master_limpio.csv"
...
# ============================
cols_puntos = [c for c in df.columns if "Puntos" in c and c != "Puntos Totales"]
